...
# tournament_and_patterns = TournamentAndPatterns(tournament, patterns, 'A')
# tournaments_and_patterns.save_single_tournament_and_patterns(tournament_and_patterns, 'testfile_2.json')
