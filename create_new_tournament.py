...
# tournament_and_patterns = tournament_and_patterns_dao.generate_single_tournament_and_patterns(20, [[0], [2]], PatternDescription.TWO_PATTERNS_EACH_WITH_ONE_STATE, 'size_20')
