            ...
            for initial_activity_parameter_factor in initial_activity_parameter_factors:
                ...
                for training_set_size in training_set_size_list:
                    ...
                    for exuberant_system in exuberant_systems:
                        ...
                        result = TrainingAnalysisData(exuberant_system.id, None, number_of_states, number_of_patterns, driving_value, initial_activity_parameter_factor, travel_time, algorithm, learning_rate, desired_residence_time, training_set_size, calculation_duration)
