...
def train_example():
    ...
    initial_dynamics = initialize_dynamics(exuberant_system, 7, 10, 1)
    training_result = train_starting_with_random_vertex_n_times(initial_dynamics, LearningAlgorithm.LOOK_FORWARD_AND_ONLY_ONCE_PER_ARC, 0.5, 0.2, 300)
