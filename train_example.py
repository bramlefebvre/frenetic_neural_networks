...
def train_example():
    ...
    tournament_and_patterns = generate_single_tournament_and_patterns(50, patterns)
    ...
    training_result = train_starting_with_random_vertex_n_times(initial_dynamics, LearningAlgorithm.LOOK_FORWARD_AND_ONLY_ONCE_PER_ARC, 0.5, 0.2, 200)
